...
const iconEdit =
    <svg className="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="orange"
...
const iconDelete =
    <svg className="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="red"
         xmlns="http://www.w3.org/2000/svg">
        <path
...
const iconAdd =
    <svg className="bi bi-plus-square-fill" width="2em" height="2em" viewBox="0 0 16 16" fill="green"
         xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd"
...
export {iconAdd, iconDelete, iconEdit};